...
export class TransactionDto {
    ...
    @Expose()
    @OptionalDecimal("Transaction amount", 5000.00)
    amount: number;
    ...
    @Expose()
    @OptionalEnum(TransactionType, "Type of transaction", TransactionType.EXPENSE)
    ...
    @Expose()
    @OptionalEnum(TransactionStatus, "Transaction status", TransactionStatus.COMPLETED)
